...
# hide shared memory from fork processes, stop otcic from re-importing
# check for "app" instead of "__main__" because running from a flask command
if __name__ == "app":
    ...
    print("Make row function declared")
    @otcic.ram_trace
    def make_row() -> Row:
        print("Making row - pre-pool, pid:", os.getpid())
